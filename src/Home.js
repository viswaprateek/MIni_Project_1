  ...
  return (
    ...
    >
      <img
        src={product.image}
        alt={product.title}
        className="product-card-image w-full h-48 object-cover rounded-t-md "
      ...
      <div className="product-card-details">
        <div className="p-4">
          ...
          <div className="mt-4">
            <button className="product-card-button px-4 py-2 rounded-md " onClick={handleViewDetails}>View Details</button>
          </div>
        </div>
      </div>
    </div>
